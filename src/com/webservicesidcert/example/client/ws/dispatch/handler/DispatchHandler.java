package com.webservicesidcert.example.client.ws.dispatch.handler;

import com.sun.xml.wss.ProcessingContext;
import com.sun.xml.wss.XWSSProcessor;
import com.sun.xml.wss.XWSSProcessorFactory;
import com.webservicesidcert.example.client.ws.port.handler.Prompter;
...
public class DispatchHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    public DispatchHandler() {
        ...
        try {
            ...
            FileInputStream config = new FileInputStream(new File("//Users//Sidney//Dev//repositories//JavaWSCertifications//Main//src//com//webservicesidcert//example//client//ws//client.xml"));
            xwssClient =
