package com.webservicesidcert.example.client.ws.port.handler;
...
public class ClientHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    public ClientHandler() {
        ...
        try {
            ...
            FileInputStream config = new FileInputStream(new File("/Users/admin/git_repositories/prosidney/WSCertification/Main/src/com/webservicesidcert/example/client/client.xml"));
            xwssClient =
